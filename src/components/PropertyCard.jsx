...
const PropertyCard = () => {
  ...
  const { products, prodSuccess, productError } = useSelector(
            ...
            >
              <div className="p-5">
                <img
                  ...
                  src={`https://api.safehomeproperties.com/uploads/${product.image}`}
                  alt={product.title}
                />
              </div>
              <div className="flex justify-center">
                <IoLocationOutline className="text-[#C8C8C8]" size={30} />{" "}
                <p className="ms-3 text-[#C8C8C8]">{product.location}</p>
              </div>
              ...
              <div className="p-4">
                ...
                <div className="flex justify-evenly my-4">
                  <div className="flex justify-evenly">
                    ...
                    <p className="text-[#C8C8C8] ms-3"> {product.rooms}</p>
                  </div>
                  <div className="flex justify-evenly">
                    <IoWaterOutline className="text-[#C8C8C8] size-5" />{" "}
                    <p className="text-[#C8C8C8] ms-3">{product.baths}</p>{" "}
                  </div>
                  <div className="flex justify-evenly">
                    <PiRectangleDashedLight className="text-[#C8C8C8] size-5" />{" "}
                    <p className="text-[#C8C8C8] ms-3">{product.size} sqft</p>
                  </div>
                  <Link
