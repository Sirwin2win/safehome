...
const PropertyCard = () => {
  ...
  const properties = [
    {id:1, title:'WaterGate Estate', price:200000000, image:watergate, type:'For Sale',location:'Asokoro Abj',features:{bed:2,bath:2,size:1800}},
    {id:2, title:'Wonderland Estate', price:300000000, image:wonderland, type:'For Rent',location:'Wuse II Abj',features:{bed:2,bath:2,size:1800}},
    {id:3, title:'Aso Garden Estate', price:400000000, image:aso, type:'For Sale',location:'Asokoro Abj',features:{bed:2,bath:2,size:1800}},
    {id:4, title:'Burumark Estate', price:270000000, image:burumark, type:'For Sale',location:'Gwarinpa Abj',features:{bed:2,bath:2,size:1800}},
    {id:5, title:'Prime Estate', price:410000000, image:prime, type:'For Sale',location:'Dawaki Abj',features:{bed:2,bath:2,size:1800}},
    {id:6, title:'The Real Life Estate', price:180000000, image:real, type:'For Sale',location:'Lifecamp Abj',features:{bed:2,bath:2,size:1800}},
  ]
  return (
 <div className=''>
       <div className='grid sm:grid-cols-2 md:grid-cols-3 pt-5 gap-1'>
