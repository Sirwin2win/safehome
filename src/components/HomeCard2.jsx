    ...
    <div className="flex justify-center bg-[#AAD7EB80] mx-5 h-60 md:mx-20 md:justify-evenly mt-10 rounded-md md:h-120">
      ...
      <div className="mt-0 w-60 md:w-150 md:ms-5 md:pe-20">
        <p className="text-sm md:text-3xl font-bold mb-5 md:text-right md:my-10 px-2">
          Seamless Property Management & Real-Time Oversight
        </p>
        <p className="px-2 text-xs md:text-xl md:text-right">
          Our systems are built to simplify property ownership from acquisition
          to management We provide real-time updates, transparent processes and
          hands-on support, ensuring every property decision is informed, secure
          and stress-free.
        </p>
      </div>
      ...
      <div className="h-40 w-40  bg-[#AAD7EB] md:w-150 md:h-90">
        <img
          src={deal}
          alt="payment card"
          className="mt-5 md:-mt-5 md:size-105"
        />
