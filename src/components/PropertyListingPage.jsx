    ...
    <div>
            <div className='grid sm:grid-cols-2 md:grid-cols-2 pt-5 gap-6'>
              ...
              <div className='flex justify-center'>
                <IoLocationOutline className='text-[#C8C8C8]' size={30}/> <p className='ms-3 text-[#C8C8C8]'>{product.address}</p>
              </div>
              
              <div className="p-4">
                <div className='flex justify-evenly'>
            
                <h2 className="mb-2 text-lg font-medium dark:text-white text-gray-900">{product.type}</h2>
               <p className="mr-2 text-lg font-semibold text-gray-900 dark:text-white">₦{product.rent_amount}</p>
                </div>
                <div className="flex justify-evenly my-4">
                <div className="flex justify-evenly"><FaBed className='text-[#C8C8C8] size-5' /> <p className='text-[#C8C8C8] ms-3'> {product.bedrooms}</p></div>
                <div className="flex justify-evenly"><IoWaterOutline className='text-[#C8C8C8] size-5' /> <p className='text-[#C8C8C8] ms-3'>{product.bathrooms}</p> </div>
