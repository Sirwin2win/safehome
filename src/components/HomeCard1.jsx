...
const HomeCard1 = () => {
  return (
    <div className='flex justify-center bg-[#9979C380] mx-5 md:mx-20 md:justify-evenly mt-10 rounded-md md:h-120'>
        <img src={payment} alt="payment card" className='w-40 bg-[#9979C3] md:w-150' />
