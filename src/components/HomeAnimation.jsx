    ...
    {/* Buy/Rent Desktop started */}
            <form className='absolute hidden md:block text-white top-100 -ms-7'>
                ...
                {/* <div className='grid grid-cols-4 gap-3 mt-5'> */}
                  <div className='flex justify-evenly md:bg-[#223B7E99] text-white p-2 w-80 mx-5'> <IoLocationOutline /><span>Location</span><select className='bg-[#223B7E99]'>
                     <option value="" disabled selected></option> 
                     <option value="">Wuse</option> 
                     <option value="">Asokoro</option> 
                     
                      </select></div>
                  <div className='flex justify-evenly md:bg-[#223B7E99] text-white p-2 w-80 '> <FiHome /> <span>Property Type </span>
                  ...
                  <div className='flex justify-evenly md:bg-[#223B7E99] text-white p-2 w-80 mx-5'> <TbCurrencyNaira  /><span>Budget </span>
                  <select className='bg-[#223B7E99]'>
                     <option value="" disabled selected></option> 
                  ...
                  <div className='flex justify-evenly md:bg-[#223B7E99] text-white p-2 w-78'> <TbAdjustmentsHorizontal  /> <span>Target Filters </span>
                  <select className='bg-[#223B7E99]'>
                     <option value="" disabled selected></option> 
                ...
                <div 
                className="flex justify-between relative p-2 left-280 top-2 hidden md:block w-50 h-10 bg-[#EF6700C9] rounded-lg">
                            <IoSearchOutline className='text-white size-5 absolute' />
                           <input type="search" className='w-40 placeholder:ps-10 placeholder:text-xl placeholder:text-white'
                            placeholder='search' />
          </div>
              </form>
