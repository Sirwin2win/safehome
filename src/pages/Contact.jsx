...
const Contact = () => {
  ...
  return (
    <div className="px-5">
      <p className="text-xl md:text-5xl text-center font-bold my-10">
        Let’s Talk
      </p>
      <p className="text-center">
        We’re here to help you find your perfect property. Reach out via the
        form or schedule a tour directly
      </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="my-10">
            <textarea
              ...
              className="w-full border border-gray-500 h-50 md:h-100 placeholder:text-3xl placeholder:p-5"
            ></textarea>
          </div>
          ...
          <div className="relative mb-20">
            <button className="bg-[#223B7EC9] w-full rounded-lg text-white text-lg py-2">
              <span>
                {" "}
                {status === "loading" ? "Sending mail..." : "Email Us"}
              </span>
            </button>
