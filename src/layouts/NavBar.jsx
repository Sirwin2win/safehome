    ...
    <GiHamburgerMenu className="size-8" />
      ...
      {isOpen && (
        <ul className="md:hidden absolute top-full left-25 w-full oma ps-35 -ms-25 pb-4  z-50">
          ...
          <li>
          <Link to={'/'} className="hover:text-gray-300 text-2xl" onClick={() => setIsOpen(false)}>Home</Link>
          </li>
          <li className='my-5'>
          <Link to={'/about'} className="hover:text-gray-300 text-2xl" onClick={() => setIsOpen(false)}>About Us</Link>
          </li>
          <li>
          <Link to={'/listings'} className="hover:text-gray-300 text-2xl" onClick={() => setIsOpen(false)}>Listings</Link>
          </li>
          <li className='my-5'>
          <Link to={'/services'} className="hover:text-gray-300 text-2xl" onClick={() => setIsOpen(false)}>Services</Link>
          </li>
          <li className='mb-5'>
